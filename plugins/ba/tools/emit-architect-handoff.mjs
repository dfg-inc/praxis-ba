 ...
 *
 * Usage:
 *   node <plugin>/tools/emit-architect-handoff.mjs \
 *     --repo <canon-root> --wp <WP-ID> [--out <path>]
 *
 * Prefer automatic emission via `praxis-ba wp approve-plan` (same payload).
 * This script remains for re-emit / CI without re-approving.
 */
...
const out =
  flag("--out") ??
  join(repo, "wp", wpId ?? "_", "handoffs", "ba-architect.handoff.json");
